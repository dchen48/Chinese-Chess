...
class SuperSoldierTest {

	@Test
	void test() {
		//tests for red super soldier
				Board board=new Board();
				Piece b1 = new SuperSoldier(true,2,3,board);
				board.addPiece(b1);
				...
				Piece b3 = new SuperSoldier(true,2,6,board);
				board.addPiece(b3);	
				assertTrue(b3.canMove(3, 6),"Move success");  
				assertTrue(b3.canMove(1, 6),"Move success");  
				assertTrue(b3.canMove(2, 7),"Move success"); 
				assertFalse(b3.canMove(4, 6),"Move fail"); 
				
				assertTrue(b1.getName()=="大兵","correct name");  
				//tests for black super soldier 
				Board board2=new Board();
				Piece b4 = new SuperSoldier(false,2,6,board2);
				board2.addPiece(b4);
				...
				Piece b6 = new SuperSoldier(false,2,3,board2);
				board2.addPiece(b6);	
				assertTrue(b6.canMove(3, 3),"Move success");
				assertTrue(b6.canMove(1, 3),"Move success");
				assertTrue(b6.canMove(2, 2),"Move success"); 
				assertFalse(b6.canMove(4, 3),"Move success");
				assertTrue(b4.getName()=="大卒","correct name");  
